...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTaskEntity = new EntityInsertionAdapter<TaskEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`id`,`jobId`,`assignedFreelancerId`,`title`,`description`,`status`) VALUES (?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(3, entity.getAssignedFreelancerId());
    ...
    this.__updateAdapterOfTaskEntity = new EntityDeletionOrUpdateAdapter<TaskEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`jobId` = ?,`assignedFreelancerId` = ?,`title` = ?,`description` = ?,`status` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Flow<List<TaskEntity>> getTasksForJob(final String jobId) {
    final String _sql = "SELECT * FROM tasks WHERE jobId = ?";
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"tasks"}, new Callable<List<TaskEntity>>() {
      ...
      public List<TaskEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfAssignedFreelancerId = CursorUtil.getColumnIndexOrThrow(_cursor, "assignedFreelancerId");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpAssignedFreelancerId;
            _tmpAssignedFreelancerId = _cursor.getString(_cursorIndexOfAssignedFreelancerId);
            ...
            _item = new TaskEntity(_tmpId,_tmpJobId,_tmpAssignedFreelancerId,_tmpTitle,_tmpDescription,_tmpStatus);
            _result.add(_item);
          }
          return _result;
        } finally {
