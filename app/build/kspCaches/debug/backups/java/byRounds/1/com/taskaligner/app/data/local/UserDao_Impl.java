  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`name`,`role`,`headline`,`profilePicUrl`) VALUES (?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(4, entity.getHeadline());
        if (entity.getProfilePicUrl() == null) {
          statement.bindNull(5);
        } else {
          statement.bindString(5, entity.getProfilePicUrl());
        }
      }
    };
  }
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpId,_tmpName,_tmpRole,_tmpHeadline,_tmpProfilePicUrl);
          } else {
            _result = null;
          }
          return _result;
