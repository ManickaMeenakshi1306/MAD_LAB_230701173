...
public final class MessageDao_Impl implements MessageDao {
  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessageEntity = new EntityInsertionAdapter<MessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`jobId`,`senderId`,`receiverId`,`content`,`timestamp`) VALUES (?,?,?,?,?,?)";
      }
  ...
  @Override
  public Flow<List<MessageEntity>> getMessagesForJob(final String jobId) {
    final String _sql = "SELECT * FROM messages WHERE jobId = ? ORDER BY timestamp ASC";
      ...
      public List<MessageEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new MessageEntity(_tmpId,_tmpJobId,_tmpSenderId,_tmpReceiverId,_tmpContent,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
